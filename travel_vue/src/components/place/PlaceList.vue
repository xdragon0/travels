                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center">
                            ...
                            <a href="javascript:;" @click="updatePlace(place.id)">修改景点</a><br>
    ...
    export default {
        ...
        methods: {
            findAllPage(index) {
                ...
                this.axios.get("/place/findAllPlace?provinceId=" + this.id).then((res) => {
                    console.log(res)
            ...
            updatePlace(id){
                this.$router.push("/update_place?=" + id)
            }
        },
        created() {
